...
public class ASO extends OverlayPanel {

    private final AutoSarachnis plugin;
    private final ASC config;

    @Inject
    private ASO(final AutoSarachnis plugin, final ASC config) {
        super(plugin);
